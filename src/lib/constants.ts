...
export const DEFAULT_PARTIES: PartyData[] = [
  {
    ...
    variants: [
      { name: "Jean-Luc Mélenchon", shortName: "Mélenchon", initials: "Mélenchon", polled: true, pollGroup: null, dynamique: 0.4, left: 0.95, center: 0.05, right: 0, startAgrege: 14.8, startCustom: 14.8, photoUrl: `${PHOTO_BASE}jean-luc-melenchon.jpg` },
    ],
  },
  {
    tag: "PCF", party: "Parti Communiste Français", active: true, selectedIdx: 0,
    variants: [
      { name: "Fabien Roussel", shortName: "Roussel", initials: "Roussel", polled: false, pollGroup: null, dynamique: -0.2, left: 0.9, center: 0.1, right: 0.1, startAgrege: 1.8, startCustom: 1.8, photoUrl: `${PHOTO_BASE}fabien-roussel.jpg` },
    ],
  },
  {
    tag: "EELV", party: "Les Écologistes", active: true, selectedIdx: 0,
    variants: [
      { name: "Marine Tondelier", shortName: "Tondelier", initials: "Tondelier", polled: false, pollGroup: "Les Écologistes", dynamique: -0.4, left: 0.85, center: 0.2, right: 0, startAgrege: 2.7, startCustom: 2.7, photoUrl: `${PHOTO_BASE}marine-tondelier.jpg` },
    ],
  },
  {
    tag: "PS", party: "PS / Place Publique", active: true, selectedIdx: 0,
    variants: [
      { name: "Raphaël Glucksmann", shortName: "Glucksmann", initials: "Glucksmann", polled: true, pollGroup: "Place Publique", dynamique: 0.3, left: 0.7, center: 0.45, right: 0.05, startAgrege: 9.7, startCustom: 9.7, photoUrl: `${PHOTO_BASE}raphael-glucksmann.jpg` },
    ],
  },
  {
    tag: "REN", party: "Renaissance", active: true, selectedIdx: 0,
    variants: [
      { name: "Gabriel Attal", shortName: "Attal", initials: "Attal", polled: true, pollGroup: "Renaissance", dynamique: 0.5, left: 0.3, center: 0.85, right: 0.4, startAgrege: 10, startCustom: 10, photoUrl: `${PHOTO_BASE}gabriel-attal.jpg` },
    ],
  },
  {
    tag: "HOR", party: "Horizons", active: true, selectedIdx: 0,
    variants: [
      { name: "Édouard Philippe", shortName: "Philippe", initials: "Philippe", polled: true, pollGroup: "Horizons", dynamique: -0.3, left: 0.15, center: 0.7, right: 0.55, startAgrege: 14.6, startCustom: 14.6, photoUrl: `${PHOTO_BASE}edouard-philippe.jpg` },
    ],
  },
  {
    tag: "DVD", party: "Divers droite", active: true, selectedIdx: 0,
    variants: [
      { name: "Dominique de Villepin", shortName: "Villepin", initials: "Villepin", polled: false, pollGroup: null, dynamique: 0.2, left: 0.25, center: 0.6, right: 0.5, startAgrege: 3.2, startCustom: 3.2, photoUrl: `${PHOTO_BASE}dominique-de-villepin.jpg` },
    ],
  },
  {
    tag: "LR", party: "Les Républicains", active: true, selectedIdx: 0,
    variants: [
      { name: "Bruno Retailleau", shortName: "Retailleau", initials: "Retailleau", polled: true, pollGroup: null, dynamique: -0.3, left: 0, center: 0.3, right: 0.85, startAgrege: 7, startCustom: 7, photoUrl: `${PHOTO_BASE}bruno-retailleau.jpg` },
    ],
  },
  {
    ...
    variants: [
      { name: "Nicolas Dupont-Aignan", shortName: "Dupont-Aignan", initials: "Dupont-Aignan", polled: false, pollGroup: null, dynamique: -0.1, left: 0.05, center: 0.15, right: 0.85, startAgrege: 2.7, startCustom: 2.7, photoUrl: `${PHOTO_BASE}nicolas-dupont-aignan.jpg` },
    ],
  },
  {
    tag: "RN", party: "Rassemblement National", active: true, selectedIdx: 0,
    variants: [
      { name: "Marine Le Pen", shortName: "Le Pen", initials: "Le Pen", polled: true, pollGroup: null, dynamique: 0.2, left: 0.1, center: 0.1, right: 0.9, startAgrege: 30.8, startCustom: 30.8, photoUrl: `${PHOTO_BASE}marine-le-pen.jpg` },
    ],
  },
  {
    tag: "REC", party: "Reconquête", active: true, selectedIdx: 0,
    variants: [
      { name: "Éric Zemmour", shortName: "Zemmour", initials: "Zemmour", polled: true, pollGroup: null, dynamique: -0.3, left: 0, center: 0, right: 1, startAgrege: 2.7, startCustom: 2.7, photoUrl: `${PHOTO_BASE}eric-zemmour.jpg` },
    ],
  },
];
