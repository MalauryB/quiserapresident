...
export const DEFAULT_PARTIES: PartyData[] = [
  {
    ...
    variants: [
      { name: "Jean-Luc Mélenchon", shortName: "Mélenchon", initials: "Mélenchon", polled: true, pollGroup: null, dynamique: 0.5, left: 1.0, center: 0.0, right: 0.0, startAgrege: 14.5, startCustom: 13.7, photoUrl: `${PHOTO_BASE}jean-luc-melenchon.jpg` },
  ...
  },
  {
    ...
    variants: [
      { name: "Fabien Roussel", shortName: "Roussel", initials: "Roussel", polled: false, pollGroup: null, dynamique: 0.0, left: 0.8, center: 0.0, right: 0.2, startAgrege: 3.5, startCustom: 3.2, photoUrl: `${PHOTO_BASE}fabien-roussel.jpg` },
    ],
  },
  {
    tag: "EELV", party: "Primaire union de la gauche", active: true, selectedIdx: 0,
    variants: [
      { name: "Marine Tondelier", shortName: "Tondelier", initials: "Tondelier", polled: false, pollGroup: "Les Écologistes", dynamique: 0.0, left: 0.7, center: 0.3, right: 0.0, startAgrege: 3, startCustom: 6.3, photoUrl: `${PHOTO_BASE}marine-tondelier.jpg` },
  ...
  },
  {
    ...
    variants: [
      { name: "Raphaël Glucksmann", shortName: "Glucksmann", initials: "Glucksmann", polled: true, pollGroup: "Place Publique", dynamique: -0.2, left: 0.3, center: 0.7, right: 0.0, startAgrege: 10.5, startCustom: 14.2, photoUrl: `${PHOTO_BASE}raphael-glucksmann.jpg` },
  ...
  },
  {
    ...
    variants: [
      ...
      { name: "Édouard Philippe", shortName: "Philippe", initials: "Philippe", polled: true, pollGroup: "Horizons", dynamique: -0.5, left: 0.0, center: 0.8, right: 0.2, startAgrege: 16, startCustom: 19, photoUrl: `${PHOTO_BASE}edouard-philippe.jpg` },
    ],
  },
  {
    tag: "LR", party: "Les Républicains", active: true, selectedIdx: 0,
    variants: [
      { name: "Bruno Retailleau", shortName: "Retailleau", initials: "Retailleau", polled: true, pollGroup: null, dynamique: 0.5, left: 0.0, center: 0.3, right: 0.7, startAgrege: 9.5, startCustom: 8.4, photoUrl: `${PHOTO_BASE}bruno-retailleau.jpg` },
  ...
  },
  {
    ...
    variants: [
      { name: "Jordan Bardella", shortName: "Bardella", initials: "Bardella", polled: true, pollGroup: null, dynamique: -0.5, left: 0.0, center: 0.1, right: 0.9, startAgrege: 33, startCustom: 37.4, photoUrl: `${PHOTO_BASE}jordan-bardella.jpg` },
      { name: "Marine Le Pen", shortName: "Le Pen", initials: "Le Pen", polled: true, pollGroup: null, dynamique: 0.2, left: 0.0, center: 0.1, right: 0.9, startAgrege: 32, startCustom: 34, photoUrl: `${PHOTO_BASE}marine-le-pen.jpg` },
    ],
  },
  {
    tag: "REC", party: "Reconquête", active: true, selectedIdx: 0,
    variants: [
      { name: "Éric Zemmour", shortName: "Zemmour", initials: "Zemmour", polled: true, pollGroup: null, dynamique: 0.0, left: 0.0, center: 0.0, right: 1.0, startAgrege: 5.5, startCustom: 4.2, photoUrl: `${PHOTO_BASE}eric-zemmour.jpg` },
