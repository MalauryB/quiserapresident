...
-- Retirés : Hollande (ps-1) et Faure (ps-2) sont désormais dans seed.sql sous
-- dvg-0 et ps-0 — les conserver ici provoquerait un conflit de clé primaire.
-- Autain (rec-1) a été retirée de la simulation.
--
-- Rappel : ces candidats ne sont pas affichés tant qu'ils ne figurent pas
-- aussi dans DEFAULT_PARTIES (src/lib/constants.ts), qui fait foi côté front.
